...
<div class="d-flex align-items-center mb-3">
    ...
    <form action="salas.php?action=criar" method="POST" class="d-flex align-items-center">
        <div class="form-floating me-2" style="flex: 1;">
            <input type="text" class="form-control form-control-sm" id="idtempo" name="idtempo" placeholder="ID da Sala (interno)" required>
            <label for="idtempo">ID da Sala (interno)</label>
        </div>
        <div class="form-floating me-2" style="flex: 1;">
