<?php
    ...
    if (isset($_GET['action']) && $_GET['action'] == "logout"){
        ...
        echo "box-shadow: 0 4px 20px rgba(0,0,0,0.2);";
...
<?php
        ...
        echo "}";
        echo "";
        echo ".divider::before, .divider::after {";
        echo "content: '';";
        echo "flex: 1;";
        ...
        echo "}";
        echo "";
        echo ".email-form input[type='email'] {";
        echo "width: 100%;";
        echo "padding: 0.8rem;";
        echo "border: 1px solid #ccc;";
        echo "border-radius: 8px;";
        echo "font-size: 1rem;";
        echo "margin-bottom: 0.8rem;";
        echo "box-sizing: border-box;";
        echo "}";
        echo "";
        echo ".email-form input[type='email']:focus {";
        echo "outline: none;";
        ...
        echo "}";
        echo "";
        echo ".email-btn:hover {";
        echo "background-color: #004494;";
        echo "}";
        echo "";
        echo ".error-message {";
        echo "color: #dc3545;";
        ...
        echo "</style>";
        echo "";
        echo "<div class=\"divider\"><span>ou</span></div>";
        echo "";
        echo "<form class=\"email-form\" action=\"/login/external.php\" method=\"POST\">";
        echo csrf_token_field();
        if (isset($_GET['external_error'])) {
            $errorMsg = htmlspecialchars($_GET['external_error'], ENT_QUOTES, 'UTF-8');
            echo "<p class=\"error-message\">{$errorMsg}</p>";
        }
        echo "<input type=\"email\" name=\"email\" placeholder=\"Email externo\" required>";
        echo "<button type=\"submit\" class=\"login-btn email-btn\">Receber código de acesso</button>";
        echo "</form>";
        echo "<p class=\"small\" style=\"margin-top: 0.8rem; font-size: 0.75rem; color: #666;\">Para utilizadores externos (não @aejics.org)</p>";
        echo "</div>";
        echo "";
        echo "<div class=\"notice\">";
        echo "<strong>Este website é oficial do Agrupamento de Escolas Joaquim Inácio da Cruz Sobral.</strong>";
