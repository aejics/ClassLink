<?php
    ...
    $db->query("CREATE TABLE IF NOT EXISTS reservas (sala VARCHAR(99) UNIQUE, tempo INTEGER UNIQUE, requisitor VARCHAR(99) UNIQUE, FOREIGN KEY (tempo) REFERENCES tempos(id), FOREIGN KEY (sala) REFERENCES salas(id), FOREIGN KEY (requisitor) REFERENCES cache_giae(id));");
